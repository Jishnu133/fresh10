...
ഹായ്. എന്നെ ഉപയോഗിച്ചതിന് നന്ദി.
/ എന്നെ എങ്ങനെ ഉപയോഗിക്കാമെന്ന് അറിയാൻ സഹായിക്കുക
TL; DR, ദയവായി ഒരു നേരിട്ടുള്ള (വീഡിയോ) ലിങ്ക് അയയ്ക്കുക, ഞാൻ ടെലിഗ്രാമിൽ അപ്‌ലോഡ് ചെയ്യാൻ ശ്രമിക്കും.
"""
...
Free users only 100000 request per 4444444 minutes.
/upgrade or Try 18 seconds later."""
